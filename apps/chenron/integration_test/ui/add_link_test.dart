...
https://github.com/flutter""";
          ...
          expect(
              find.text("https://github.com/flutter"), findsAtLeastNWidgets(1));
...
https://dart.dev""";
          ...
          expect(find.textContaining("Added 2 valid URL(s) successfully"),
              findsOneWidget);
        });
...
bad input""";
          ...
          expect(find.textContaining("3 lines have errors"), findsOneWidget);
        });
...
https://dart.dev #dart""";
        ...
        testWidgets("should allow correction and resubmission of invalid URLs",
          ...
          expect(find.textContaining("1 line has errors"), findsOneWidget);
          ...
          final codeFieldState =
              tester.state<EditableCodeFieldState>(codeField);
          ...
          // Resubmit
          // Debug: print("About to tap add button...");
          await tester.tap(addButton);
          await tester.pumpAndSettle();
          // Debug: print("Tapped add button and settled.");
    ...
    group("Shared Features", () {
      group("Global Tags", () {
        testWidgets("should add global tag and apply to new bulk entries",
          ...
          final addTagButton =
              find.byKey(const Key("global_tags_tag_add_button"));
        ...
        testWidgets("should remove global tag when delete icon clicked",
          ...
          final tagChip =
              find.byKey(const Key("global_tags_tag_chip_removeme"));
        ...
        testWidgets("should validate global tag and show error for invalid tag",
          ...
          expect(find.textContaining("only contain alphabetic characters"),
              findsOneWidget);
