...
class UserConfigUpdateVEPR extends VEPROperation<
    ...
    void, // Execute returns void (only updates UserConfig)
  ...
  @override
  void validate(UserConfigUpdateInput input) {
    logStep("Validate",
    ...
    if (input.themeUpdates != null) {
      ...
      for (final theme in input.themeUpdates!.update) {
        ...
        // Assuming primarySeedValue is required for a valid theme
        // Note: The UserTheme class generated by Drift should have non-nullable int primarySeedValue
        // If it were nullable in the class, you'd check `theme.primarySeedValue == null`
        // Since it's likely non-nullable based on schema, this check might be redundant
        // if the type system enforces it, but explicit validation can be clearer.
        // if (theme.primarySeedValue == null) { // Check if it could be null
        //   throw ArgumentError("UserTheme primarySeedValue cannot be null for update (ID: ${theme.id}).");
        // }
      }
      ...
      for (final theme in input.themeUpdates!.create) {
        ...
        // Assuming primarySeedValue is required for a valid theme
        // Same note as above applies regarding nullability check.
        // if (theme.primarySeedValue == null) { // Check if it could be null
        //   throw ArgumentError("UserTheme primarySeedValue cannot be null for creation.");
        // }
      }
  ...
  @override
  Future<void> execute(UserConfigUpdateInput input) async {
  ...
  @override
  Future<UserThemeCUDResults> process(
      UserConfigUpdateInput input, void execResult) async {
  ...
  @override
  UserThemeCUDResults buildResult(
      void execResult, UserThemeCUDResults procResult) {
