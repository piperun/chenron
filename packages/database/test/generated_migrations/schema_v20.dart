...
class WebMetadataRefreshEntries extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  WebMetadataRefreshEntries(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> url = GeneratedColumn<String>(
      'url', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: true,
  ...
  late final GeneratedColumn<String> lastAttemptAt = GeneratedColumn<String>(
      'last_attempt_at', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  ...
  @override
  WebMetadataRefreshEntries createAlias(String alias) {
    return WebMetadataRefreshEntries(attachedDatabase, alias);
  }
...
class DatabaseAtV20 extends GeneratedDatabase {
  ...
  late final WebMetadataRefreshEntries webMetadataRefreshEntries =
      WebMetadataRefreshEntries(this);
